 ...
 ******************************************************************************/
struct fetch_constant : boost::proto::callable
{
  template<typename Sig> struct result;

  template<typename This,typename Value>
  struct result<This(Value)> : boost::remove_reference<Value> {};

  template<typename Value> inline
  typename result<fetch_constant(Value)>::type
  operator()(Value const& v) const
  {
    return v;
  }
};
...
struct  evaluate_
      : boost::proto::or_
        ...
        , boost::proto::when
          ...
          , fetch_constant(boost::proto::_value)
          >
