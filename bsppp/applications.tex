...
\frame
{
  ...
  \begin{block}{Results}<2->
   \only<2>{\begin{center}\pgfuseimage{mpi_omp_gmv}\end{center}}
   \only<3>{\begin{center}\pgfuseimage{hybrid_gmv}\end{center}}
   \only<4>{\begin{center}\pgfuseimage{mpi_omp_mapreduce}\end{center}}
   \only<5>{\begin{center}\pgfuseimage{hybrid_mapreduce}\end{center}}
  \end{block}{}
}
...
\frame
{
  ...
  \begin{block}{Results}<2->
   \only<2>{\begin{center}\pgfuseimage{philosophs}\end{center}}
   \only<3>{\begin{center}\pgfuseimage{sensors}\end{center}}
   \only<4>{
  \begin{itemize}
  \footnotesize
...
\frame
{
  \frametitle{Swith and Waterman DNA Comparisons}
  \begin{block}{Results}
   %\begin{center}\pgfuseimage{sw}\end{center}
  \end{block}{}
}
